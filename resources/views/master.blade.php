...
<body class="font-poppins h-auto">
    ...
    {{-- navbar --}}
<nav class="bg-blue-900 border-gray-200 text-white sticky top-0 z-50">
        ...
        <div class="hidden w-full lg:block lg:w-auto" id="navbar-dropdown">
            <ul class="flex flex-col font-medium p-4 lg:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 lg:space-x-8 rtl:space-x-reverse lg:flex-row lg:mt-0 lg:border-0 lg:bg-blue-900">
                ...
                {{-- HOME --}}
                <li>
                    <a href="{{ route('home') }}" class="block py-2 px-3 text-white bg-blue-700 rounded lg:bg-transparent lg:text-white lg:p-0" aria-current="page">Home</a>
                </li>
                ...
                <li>
                    ...
                    <div id="dropdownProfil" class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-400" aria-labelledby="dropdownLargeButton">
                            <li>
                            <a href="{{ route('profile.sambutan') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Sambutan</a>
                            </li>
                            <li>
                            <a href="{{ route('profile.sejarah') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Sejarah</a>
                            </li>
                            <li>
                            <a href="{{ route('profile.visimisi') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Visi Misi</a>
                            </li>
                            <a href="{{ route('profile.akreditasi') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Akreditasi</a>
                            </li>
                            <a href="{{ route('profile.guru') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Guru Karyawan</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <div id="dropdownInformasi" class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-400" aria-labelledby="dropdownLargeButton">
                            <li>
                            <a href="{{ route('berita') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Berita</a>
                            </li>
                        </ul>                                   
                    </div>
                </li>
                ...
                {{-- GALERI --}}
                <li>
                    <a href="{{ route('galeri') }}" class="block py-2 px-3 text-white rounded hover:bg-gray-100 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0 ">
                        Galeri
                    </a>
                </li>
            ...
            <div class="md:flex md:justify-between">
                <div class="mb-6 md:mb-0 max-w-sm">
                    <a href="https://flowbite.com/" class="flex items-center">
                        ...
                        <span class="self-center text-2xl font-semibold whitespace-nowrap text-white">SDN Ciren 1</span>
                    </a>

                    <p class="font-regular text-white mt-3 mx-auto">
                        We are an open-source library of over 400+ web 
                        components and interactive elements built with 
                        the utility classes from Tailwind CSS.
                    </p>

                    {{-- media social --}}
                    <div class="flex lg:mt-5 sm:mt-0">
                        ...
                        <a href="#" class="text-white ms-8 hover:text-gray-900">
              ...
              <div class="grid grid-cols-2 lg:gap-10 sm:gap-6 sm:grid-cols-4">
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-white uppercase">Profil</h2>
                    <ul class="text-white font-regular">
                        <li class="mb-4">
                            <a href="https://flowbite.com/" class="hover:underline">Sambutan</a>
                        </li>
                        <li class="mb-4">
                            <a href="https://tailwindcss.com/" class="hover:underline">Sejarah</a>
                        </li>
                        <li class="mb-4">
                            <a href="https://tailwindcss.com/" class="hover:underline">Visi Misi</a>
                        </li>
                        <li class="mb-4">
                            <a href="https://tailwindcss.com/" class="hover:underline">Akreditasi</a>
                        </li>
                        <li class="mb-4">
                            <a href="https://tailwindcss.com/" class="hover:underline">Guru & Karyawan</a>
                        </li>
                    </ul>
                </div>

                <div>
                    <h2 class="mb-6 text-sm font-semibold text-white uppercase">Organisasi</h2>
                    <ul class="text-white font-regular">
                        <li class="mb-4">
                            <a href="https://flowbite.com/" class="hover:underline">Struktur Organisasi</a>
                        </li>
                        <li class="mb-4">
                            <a href="https://tailwindcss.com/" class="hover:underline">Dewan Sekolah</a>
                        </li>
                    </ul>
                </div>

                <div>
                    <h2 class="mb-6 text-sm font-semibold text-white uppercase">Akademik</h2>
                    <ul class="text-white font-regular">
                        <li class="mb-4">
                            <a href="https://flowbite.com/" class="hover:underline">Kurikulum</a>
                        </li>
                        <li class="mb-4">
                            <a href="https://tailwindcss.com/" class="hover:underline">Kalender Akademik</a>
                        </li>
                        <li class="mb-4">
                ...
                <div>
                    ...
                    <ul class="text-white font-regular">
                        <li class="mb-4">
                            <a href="https://flowbite.com/" class="hover:underline">Pengumuman</a>
                        </li>
                        <li class="mb-4">
                            <a href="https://tailwindcss.com/" class="hover:underline">Beirita</a>
                        </li>
                        <li class="mb-4">
                            <a href="https://tailwindcss.com/" class="hover:underline">Prestasi</a>
                        </li>
                    </ul>
                </div>
              </div>
