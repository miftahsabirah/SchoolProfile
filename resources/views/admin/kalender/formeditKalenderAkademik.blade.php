                ...
                <div class="mb-6">
                    ...
                    <div class="border-2 p-6 rounded-lg">
                        ...
                        <div id="fileUploadContainer" class="border-2 border-dashed border-gray-300 p-4 rounded-lg text-center">
                            ...
                            <img id="currentFile" src="" alt="Current File" class="mt-2 max-w-full h-auto">
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $.ajax({
                url: "http://127.0.0.1:8000/api/getdetailakademik/" + id,
                type: "GET",
                dataType: "json",
                success: function(response) {
                    if (response) {
                        ...
                        $('#kalenderAkademikForm').attr('action', 'http://127.0.0.1:8000/api/updateakademik/' + id);
                    } else {
            ...
            function populateForm(data) {
                ...
                if (data.gambar) {
                    ...
                    $('#currentImage').attr('src', 'http://localhost:8000/storage/imgakademik/' + data.gambar);
                }
                // Tambahkan logika untuk menampilkan gambar saat ini (jika ada)
                if (data.file_berkas) {
                    // Contoh menampilkan gambar dalam elemen img dengan id currentFile
                    $('#currentFile').attr('src', 'http://localhost:8000/storage/akademik/' + data.file_berkas);
                }
            }
