                    ...
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th
                                class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-2/12">
                                Deskripsi</th>
                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">File
                            </th>
    ...
    <script>
        ...
        function renderTable() {
            ...
            pageData.forEach(row => {
                const downloadUrl = "{{ Storage::url('kurikulum/') }}" + row.file_berkas;
                const tr = `
                <tr>
                    ...
                    <td class="px-4 py-4 whitespace-normal">
                        <a href="${downloadUrl}" class="text-blue-500 hover:underline">Download File</a>
                    </td>
                    <td class="px-4 py-4 whitespace-normal">
            ...
            <td class="px-4 py-4 whitespace-normal">
                            <div class="flex items-center">
                                <button class="bg-green-700 text-white px-2 py-1.5 rounded flex items-center edit-btn" data-id="${row.id}">
            ...
            $('.edit-btn').click(function() {
                ...
                window.location.href = `{{ url('/adminformeditkalenderakademik') }}/${id}`;
            });

            $('.delete-btn').click(function() {
                const id = $(this).attr('data-id');
                deleteKalenderItem(id);
            });
        ...
        function deleteKalenderItem(id) {
            // Remove the confirm dialog
            $.ajax({
                url: `http://127.0.0.1:8000/api/deleteakademik/${id}`,
                type: 'DELETE',
                success: function(response) {
