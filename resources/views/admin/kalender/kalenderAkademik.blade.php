            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-2/12">Ikon</th>
                        <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Tahun Akademik</th>
                        <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-2/12">Deskripsi</th>
...
<script>
    const data = [
        { id: 1, ikon: 'img/ikon.png', tahun: '2023', deskripsi: 'Lorem ipsum', file: 'Lorem ipsum', aktif: true },
        ...
        for (const row of pageData) {
            ...
            tr.innerHTML = `
                ...
                <td class="px-4 py-4 whitespace-normal">
                    <img src="${row.ikon}" alt="Foto" class="h-16 w-16 object-cover">
                </td>
                <td class="px-4 py-4 whitespace-normal">${row.tahun}</td>
                <td class="px-4 py-4 whitespace-normal">${row.deskripsi}</td>
                <td class="px-4 py-4 whitespace-normal">${row.file}</td>
                <td class="px-4 py-4 whitespace-normal">
