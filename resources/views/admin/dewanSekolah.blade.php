...
<div class="bg-gray-100 flex justify-center h-auto">
    <div class="w-full mx-12 shadow-xl rounded-lg flex flex-col">
        <h2 class="text-sm font-medium px-6 py-3">Setting Dewan Sekolah</h2>
        <div class="bg-white rounded-br-lg rounded-bl-lg shadow-lg flex-1 overflow-y-auto">
            <button class="bg-blue-600 text-white text-xs px-4 py-2 rounded-lg m-4">+ Tambah Tugas</button>
    ...
    function renderTable() {
        ...
        for (const row of pageData) {
            ...
            tr.innerHTML = `
                ...
                <td class="px-6 py-4 whitespace-normal w-1/3">${row.deskripsi}</td>
