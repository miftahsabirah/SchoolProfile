    ...
    <div class="w-full max-w-4xl shadow-xl rounded-lg">
        ...
        <div class="bg-white p-6 rounded-br-lg rounded-bl-lg shadow-lg w-full">
            <form>
                <div class="mb-5">
                    <form class="mx-auto">
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="baganOrganisasi">Tambahkan Bagan Organisasi</label>
                        <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="baganOrganisasi" id="baganOrganisasi" type="file">
                    </form>
                </div>
