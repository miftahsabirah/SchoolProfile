                ...
                <div class="flex flex-col flex-1 pt-5 pb-4">
                    <div class="flex-1 px-2 space-y-1 divide-y divide-gray-200">
                        <ul class="pb-1 space-y-1">
                            <li>
                                <a href="./index.html"
                                    class="flex items-center p-2 text-base font-normal text-white rounded-lg">
                            ...
                            <li>
                                <button type="button"
                                    class="flex items-center p-2 w-full text-sm font-normal text-white rounded-lg hover:text-gray-900 transition duration-75 group hover:bg-gray-100"
                            ...
                            <li>
                                <a href="./mailing/inbox.html"
                                    ...
                                    <span class="flex-1 ml-3 whitespace-nowrap" sidebar-toggle-item>Sarana &
                                        Prasarana</span>
                                </a>
                            </li>
                            <li>
                            ...
                            <form action="#" method="GET" class="w-4/5 mr-4 lg:mr-0">
                                ...
                                <div class="relative w-full">
                                    <div class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                                        <svg class="w-5 h-5 text-white dark:text-gray-400" fill="currentColor"
                                            viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd"
                                                d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z"
                                                clip-rule="evenodd"></path>
    ...
    <script>
        ...
        const toggleSidebar = (sidebarEl, expand, setExpanded = false) => {
            ...
            if (expand) {
                ...
                document.querySelectorAll('#' + sidebarEl.getAttribute('id') + ' [sidebar-toggle-item]').forEach(
                    sidebarToggleEl => {
