...
<div class="bg-gray-100 flex flex-col justify-center items-center h-auto">
    <div class="w-full max-w-4xl shadow-xl rounded-lg mb-16">
        ...
        <div class="bg-white p-6 rounded-br-lg rounded-bl-lg shadow-lg w-full h-auto">
            <form>
                <div class="mt-8">
                    <label class="block text-sm font-medium text-gray-900 mb-2">Deskripsi Visi</label>
                    ...
                    <div>
                        <button type="submit" class="w-full bg-blue-700 text-white p-2 rounded-lg mb-10 hover:bg-blue-700">Simpan Perubahan</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="w-full max-w-4xl shadow-xl rounded-lg">
        ...
        <div class="bg-white p-6 rounded-br-lg rounded-bl-lg shadow-lg w-full h-auto">
            <form>
                <div class="mt-8">
                    <label class="block text-sm font-medium text-gray-900 mb-2">Deskripsi Misi</label>
                    <div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                        <div class="flex items-center justify-between px-3 py-2 border-b dark:border-gray-600">
                            <div class="flex flex-wrap items-center divide-gray-200 sm:divide-x sm:rtl:divide-x-reverse dark:divide-gray-600">
                                <div class="flex items-center space-x-1 rtl:space-x-reverse sm:pe-4">
                    ...
                    <div>
                        <button type="submit" class="w-full bg-blue-700 text-white p-1.5 rounded-lg mb-10 hover:bg-blue-800">Simpan Perubahan</button>
                    </div>
                </div>
            </form>
        </div>
