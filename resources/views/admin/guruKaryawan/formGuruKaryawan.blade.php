            ...
            <div class="bg-white p-6 rounded-br-lg rounded-bl-lg shadow-lg w-full">
                <form>
                    <div class="mb-5">
                        ...
                        <input type="text" id="jabatan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan nama jabatan" required />
                    </div>
                    <div class="mb-10">
                        <label for="deskripsiTentang" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Deskripsi Jabatan</label>
