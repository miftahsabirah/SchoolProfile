...
<div class="bg-gray-100 flex justify-center h-auto">
    <div class="w-full mx-12 shadow-xl rounded-lg flex flex-col">
        ...
        <div class="bg-white rounded-br-lg rounded-bl-lg shadow-lg flex-1 overflow-y-auto">
            <button onclick="window.location.href='{{ route('adminformsarpras') }}'"
...
<script>
    ...
    function renderTable() {
        ...
        $('.edit-btn').click(function() {
                ...
                window.location.href = `{{ url('/adminformeditsarpras') }}/${id}`;
            });

        $('.delete-btn').click(function() {
            const id = $(this).attr('data-id');
            deleteSarprasItem(id);
        });
    ...
    function deleteSarprasItem(id) {
            // Remove the confirm dialog
            $.ajax({
                url: `http://127.0.0.1:8000/api/deletesarpras/${id}`,
                type: 'DELETE',
                success: function(response) {
