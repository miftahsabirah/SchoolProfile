        ...
        <ul class="flex flex-wrap -mb-px">
            ...
            <li class="me-2">
                <a href="#" data-filter="guru"
                    class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 filter-link">Guru</a>
            </li>
            <li class="me-2">
                <a href="#" data-filter="Kepala Sekolah"
                    class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 filter-link">Kepala
                    Sekolah</a>
            </li>
            <li class="me-2">
                <a href="#" data-filter="karyawan"
                    class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 filter-link">Staf</a>
            </li>
        </ul>
    </div>
                    ...
                    if (Array.isArray(response)) {
                        ...
                        response.forEach(function(item) {
                            if (!filter || item.jabatan.nama_jabatan.toLowerCase() === filter
                                ...
                                html += '<p class="text-xl font-normal">' + item.jabatan.nama_jabatan +
                                    '</p>';
                                html += '</div>';
                                html += '</div>';
                            }
