...
@section('content')
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:px-12 sm:text-center lg:py-12">
        ...
        <p class="font-regular text-gray-500 sm:text-sm lg:text-xl" id="visi">
        </p>
    ...
    <div class="py-8 px-4 mx-auto space-y-12 max-w-screen-xl lg:space-y-20 sm:py-16 lg:px-6">
        ...
        <div class="gap-8 items-center lg:grid lg:grid-cols-2 xl:gap-16">
            <div class="text-gray-500 sm:text-lg dark:text-gray-400">
                ...
                <p class="mb-8 font-light lg:text-xl" id="misi">
                </p>
                ...
                <ul role="list" class="pt-8 my-7 space-y-5 border-t border-gray-200">
                    <li class="flex space-x-3">
                        ...
                        <span class="text-base font-medium leading-tight text-gray-900 dark:text-white">
                            Melaksanakan proses belajar mengajar yang efektif sehingga potensi siwa berkembang dengan
                            optimal melalui Pembelajaran PAIKEM.
                        </span>
                    </li>
                    ...
                    <li class="flex space-x-3">
                        ...
                        <span class="text-base font-medium leading-tight text-gray-900 dark:text-white">
                            Mengadakan program remidial dan pengayaan di setiap kelas agar kebutuhan siswa dalam
        ...
        <div class="gap-8 items-center lg:grid lg:grid-cols-2 xl:gap-16">
            ...
            <div class="text-gray-500 sm:text-lg dark:text-gray-400">
                ...
                <p class="mb-8 font-light lg:text-xl" id="Tujuan_sekolah">
                </p>
                ...
                <ul role="list" class="pt-8 my-7 space-y-5 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <li class="flex space-x-3">
                        ...
                        <span class="text-base font-medium leading-tight text-gray-900 dark:text-white">
                            Mempersiapkan peserta didik untuk mampu bersaing dalam melanjutkan pendidikan ke jenjang
                            berikutnya
                        </span>
                    </li>
                    <li class="flex space-x-3">
                        ...
                        <span class="text-base font-medium leading-tight text-gray-900 dark:text-white">
                            Meningkatkan kompetensi peserta didik untuk mengenal dan mengapresiasi ilmu pengetahuan dan
                            teknologi sehingga unggul secara akademik dan non akademik
                        </span>
                    </li>
                </ul> --}}
            ...
            success: function(response) {
                if (Array.isArray(response)) {
                    ...
                    response.forEach(function(item) {
                        $('#visi').text(item.visi);
                        $('#misi').text(item.misi);
                        $('#Tujuan_sekolah').text( item.tujuan_sekolah);
                    });
                } else {
